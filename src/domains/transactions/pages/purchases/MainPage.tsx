            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              >
                ...
                <div>
                  ...
                  <Text size="sm">
                    {selectedPurchase.serie || ""} -{" "}
                    {selectedPurchase.numero || ""}
                  </Text>
                </div>
                <div>
                  <Text size="sm" weight={500}>
                  ...
                  <Text size="sm">
                    {selectedPurchase.fechaEmision || "N/A"}
                  </Text>
                </div>
                <div>
                  <Text size="sm" weight={500}>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <Text size="sm">
                    S/ {selectedPurchase.totales?.totalIgv || "0"}
                  </Text>
                </div>
                <div>
                  <Text size="sm" weight={500}>
        ...
        <div>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <ul style={{ marginTop: "8px" }}>
              ...
              <li>
                Las Notas de Crédito y Débito no se cargan automáticamente.
              </li>
